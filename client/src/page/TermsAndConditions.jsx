...
const TermsAndConditions = () => {
    return (
        <Box p={{ xs: '65px 10px 16px 10px', md: '165px 375.5px 16px 375.5px' }} bgcolor='#0000' minHeight='inherit'>
            ...
            <Box width='100%'>
                ...
                <Typography sx={{ ...textConfigs.style.basicFont, fontWeight: '400', fontSize: '18px', mb: '0.5rem' }}>
                    (a) Confirmation. For orders which are to be picked up in a Retail Store or delivered from a Retail Store to your home, we will send you an order confirmation e-mail after we receive your online order with your order number, a description of the Products you have ordered, the location of the Retail Store where you can pick up the Products you have ordered online, or information on your selected delivery option, if applicable. Acceptance of your order and the formation of the contract of sale between Kolux and you will not take place until the servicing Kolux store reviews and processes your order.
                </Typography>
                <Typography sx={{ ...textConfigs.style.basicFont, fontWeight: '400', fontSize: '18px', mb: '0.5rem' }}>
