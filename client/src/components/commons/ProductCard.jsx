        ...
        <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", width: '100%' }}>
          ...
          <Box sx={{ mt: 1, marginTop: '-40px' }}>
            <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
              ...
              {hasHalfStar && <StarHalfIcon sx={{ color: "#f39c12", fontSize: '1rem' }} />}
              {[...Array(5 - fullStars - (hasHalfStar ? 1 : 0))].map((_, i) => (
                <StarBorderIcon key={i} sx={{ color: "#f39c12", fontSize: '1rem' }} />
              ))}
            </Box>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mt: 1, fontSize: '0.65rem' }}>
            <ul>
