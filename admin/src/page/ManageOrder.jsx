import { Avatar, Box, Button, Dialog, DialogActions, DialogContent, DialogTitle, Grid, IconButton, ImageListItem, MenuItem, Paper, Select, Stack, TableCell, TableRow, TextField, Typography } from '@mui/material'
...
const ManageOrder = () => {
    ...
    const columns = [
        ...
        { field: 'paymentStatus', headerName: 'Payment Status', width: 150, },
        {
            ...
            width: 200,
            renderCell: (params) => (
                <Stack spacing={1} direction='row' alignItems='center' width='100%' height='100%'>
